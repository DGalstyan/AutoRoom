 ...
 * `loanUrl` yet (including every in-house row, by design) falls back to a
 * plain name badge instead of a dead/missing logo. Pixel-matched to Figma
 * node 101:403.
 */
  ...
  return (
    <div className="flex flex-col items-center gap-[100px]">
      ...
      <div className="flex flex-col items-center gap-5 text-center">
        <p className="max-w-3xl text-[24px] font-light leading-[36px] text-ink">{t.inHouseText}</p>
        <button
          type="button"
