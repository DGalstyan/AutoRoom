...
| Path                      | Purpose                                                                  |
| ------------------------- | ------------------------------------------------------------------------ |
| `src/app.ts`              | Express app factory — middleware order is the contract A1/A2 slot into   |
...
| `src/middleware/`         | Error translation, 404, zod request validation                           |
| `src/rbac/permissions.ts` | The `role × resource × action` matrix, shared by the seed and A2         |
